export const TOPIC_META = {
  ...
  description:
    "Value is external. Legibility is internal. Both matter. The pathology is the slow inversion where legibility becomes more important than value because legibility is what leadership sees. How to tell load-bearing legibility from decorative legibility, and what to do about the ratio.",
  slug: "legibility-vs-value",
  keywords: [
    "engineering organization dysfunction",
    "organizational legibility",
    "value creation vs overhead",
    "diagnostic test org design",
